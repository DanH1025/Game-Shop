...
function Header() {
  ...
  return (
    <div className="flex items-center p-3">
      ...
      <div className="flex bg-slate-200 mx-5 w-full p-2 rounded-sm items-center px-2">
      ...
      {theme=='dark'?  <HiSun className="text-[35px] cursor-pointer
        text-yellow-500 p-1 rounded-full " 
        onClick={()=>setTheme('light')} />
        :
        <HiMoon className="text-[35px] cursor-pointer text-gray-400 p-1 rounded-full" 
